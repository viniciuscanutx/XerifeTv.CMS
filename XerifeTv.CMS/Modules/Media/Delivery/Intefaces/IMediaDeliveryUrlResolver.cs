...
public interface IMediaDeliveryUrlResolver
{
    ...
    Task<Result<GetResolveUrlResponseDto>> ResolveStreamCatalogFromPayloadAsync(string payload, string streamFormat, string? providerName = null, string? catalogUrl = null);
}
