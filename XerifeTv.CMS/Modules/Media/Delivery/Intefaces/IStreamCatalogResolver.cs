...
public interface IStreamCatalogResolver
{
    ...
    Task<Result<GetResolveUrlResponseDto>> ResolveFromPayloadAsync(string payload, string fallbackStreamFormat, string? providerName = null, CancellationToken cancellationToken = default);
}
